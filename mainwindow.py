...
from covert_interface import ConvertInterface
...
class Window(SplitFluentWindow):
    ...
    def initNavigation(self):
        ...
        self.addSubInterface(self.CW, FIF.HOME, 'VideoToFrames', position=NavigationItemPosition.TOP)
    ...
    def initWindow(self):
        ...
        self.setWindowTitle('VFX Onset ToolBox Ver0.1')
